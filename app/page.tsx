    ...
    <main className="min-h-screen bg-cream text-ink">
        ...
        <div className="grid gap-8">
          <div>
            ...
            <p className="text-ink/70">
              Vous entrez les chiffres, on s&apos;occupe de la mise en forme.
            </p>
          </div>
          <div>
            <h3 className="font-bold text-lg mb-1">
              Envoyé automatiquement le 1er
            </h3>
            <p className="text-ink/70">
              Plus besoin d&apos;y penser : le rapport part tout seul, à vos
              couleurs.
            </p>
          </div>
          <div>
            ...
            <p className="text-ink/70">
              Un accusé de lecture vous dit exactement quand votre client a
              ouvert son bilan.
            </p>
          </div>
        </div>
      ...
      <section className="px-6 py-10 bg-ink/5 text-center">
        <p className="text-sm text-ink/50 italic max-w-md mx-auto">
          [Emplacement réservé aux premiers retours clients — à remplacer par
      ...
      <section className="px-6 py-14 text-center max-w-lg mx-auto">
        <h2 className="text-2xl font-bold mb-4">
          Votre premier bilan, envoyé ce mois-ci
        </h2>
